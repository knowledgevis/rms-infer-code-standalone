...
def start_inference_mainthread(image_file,out_dir):
    ...
    # return image data so toplevel task can write it out. This has been modified to return 
    # a probability map instead of the labelmap in the previous code. 
...
CHANNEL_DESCRIPTION = {}
CHANNEL_DESCRIPTION['chan_0'] = 'Background_prob'
CHANNEL_DESCRIPTION['chan_1'] = 'Necrosis_prob'
CHANNEL_DESCRIPTION['chan_2'] = 'Stroma_prob'
CHANNEL_DESCRIPTION['chan_3'] = 'ARMS_prob'
CHANNEL_DESCRIPTION['chan_4'] = 'ERMS_prob'
'''
